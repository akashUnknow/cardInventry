...
import { RouteAddInventory, RouteAdddgdata, RouteBap, RouteBapCompleted, RouteBapGeneration, RouteBapHold, RouteBapReview, RouteIdsp, RouteIndex, RouteLogin, RoutePersoCard, RouteUpdate, Routecardinventry } from './helper/RouteName';
   ...
   <BrowserRouter>
      <Routes>
        <Route element={<Layout/>} path={RouteIndex} >
          ...
          <Route path={RouteBap} element={<Bap/>} />
